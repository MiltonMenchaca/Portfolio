...
import BadgesAndCertificates from './BadgesAndCertificates'; // Import Badges component
                ...
                >
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={4} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src="/path/to/project1.png" alt="Project 1" style={{ width: '80px', height: '80px' }} />
                            <Typography variant="caption" align="center" display="block">
                                Project 1
                            </Typography>
                        </Grid>
                        <Grid item xs={4} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src="/path/to/project2.png" alt="Project 2" style={{ width: '80px', height: '80px' }} />
                            <Typography variant="caption" align="center" display="block">
                                Project 2
                            </Typography>
                        </Grid>
                        <Grid item xs={4} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <img src="/path/to/project3.png" alt="Project 3" style={{ width: '80px', height: '80px' }} />
                            <Typography variant="caption" align="center" display="block">
                                Project 3
                            </Typography>
                        </Grid>
