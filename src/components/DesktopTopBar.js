// src/components/DesktopTopBar.js
    ...
    >
      ...
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <IconButton onClick={() => setLauncherOpen(!launcherOpen)} sx={{ color: '#ffffff' }}>
          <img
            src={`${process.env.PUBLIC_URL}/iconkali.png`}
            alt="Kali"
        ...
        <IconButton onClick={() => setTerminalOpen(true)} sx={{ color: '#ffffff' }}>
          <img
            src={`${process.env.PUBLIC_URL}/linuxterminal.png`}
            alt="Terminal"
        ...
        >
          <img
            src={`${process.env.PUBLIC_URL}/firefoxlogo.png`}
            alt="Firefox"
            style={{ width: 20, height: 20 }}
          />
        </IconButton>
